...
})(["animation-name:blur;animation-duration:0.2s;animation-fill-mode:both;&:hover{animation-name:hover;}@keyframes hover{from{transform:translateX(0);}to{transform:translateX(70px);}}@keyframes blur{from{transform:translateX(70px);}to{transform:translateX(0);}}"]);
...
//# sourceMappingURL=index.js.0ed12dba23b1e30359fd.hot-update.js.map