...
})(["overflow:hidden;position:relative;", "{text-shadow:none;animation-name:", ";animation-duration:0.2s;animation-fill-mode:both;color:transparent;&:hover{animation-name:hover;}@keyframes hover{from{transform:translateY(0);}to{transform:translateY(40px);}}@keyframes blur{from{transform:translateY(40px);}to{transform:translateY(0);}}}", "{position:absolute;height:40px;top:55px;right:calc(50% - 10px);animation-name:", ";animation-duration:0.2s;animation-fill-mode:both;@keyframes hover{from{transform:translateY(40px);}to{top:10px;}}@keyframes blur{from{top:10px;}to{transform:translateY(40px);}}}"], _ui__WEBPACK_IMPORTED_MODULE_10__["P"], function (_ref2) {
...
//# sourceMappingURL=index.js.3cc2b00bc0fb847dee83.hot-update.js.map