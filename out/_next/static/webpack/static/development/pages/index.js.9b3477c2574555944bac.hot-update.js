...
})(["overflow:hidden;span{animation-name:", ";animation-duration:0.2s;animation-fill-mode:both;&:hover{animation-name:hover;}@keyframes hover{from{transform:translateY(0);}to{transform:translateY(10px);}}@keyframes blur{from{transform:translateY(10px);}to{transform:translateY(0);}}}"], function (_ref2) {
...
//# sourceMappingURL=index.js.9b3477c2574555944bac.hot-update.js.map