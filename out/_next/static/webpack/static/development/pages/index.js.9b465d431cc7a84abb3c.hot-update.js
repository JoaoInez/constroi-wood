...
})(["overflow:hidden;animation-name:", ";animation-duration:0.2s;animation-fill-mode:both;@keyframes hover{from{transform:translateY(0);}to{transform:translateY(50px);}}@keyframes blur{from{transform:translateY(50px);}to{transform:translateY(0);}}"], function (_ref2) {
  var state = _ref2.state;
  return state;
});
var ContactText = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].span.withConfig({
  displayName: "index__ContactText",
  componentId: "hpb436-7"
})(["animation-name:", ";animation-duration:0.2s;animation-fill-mode:both;@keyframes hover{from{transform:translateY(0);}to{transform:translateY(50px);}}@keyframes blur{from{transform:translateY(50px);}to{transform:translateY(0);}}"], function (_ref3) {
...
var Homepage = function Homepage() {
  ...
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_ui__WEBPACK_IMPORTED_MODULE_10__["Section"], {
    ...
    __self: this
  }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(ContactText, {
    state: contactBtn,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 140
...
//# sourceMappingURL=index.js.9b465d431cc7a84abb3c.hot-update.js.map