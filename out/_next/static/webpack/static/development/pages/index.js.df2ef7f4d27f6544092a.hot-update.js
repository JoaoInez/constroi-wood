...
})(["overflow:hidden;position:relative;", "{text-shadow:none;animation-name:", ";animation-duration:0.2s;animation-fill-mode:both;pointer-events:none;&:hover{animation-name:hover;}@keyframes text_hover{from{transform:translateY(0);}to{transform:translateY(40px);}}@keyframes text_blur{from{transform:translateY(40px);}to{transform:translateY(0);}}}", "{position:absolute;height:40px;top:-55px;right:calc(50% - 10px);animation-name:", ";animation-duration:0.2s;animation-fill-mode:both;@keyframes arrow_hover{from{top:-55px;color:", ";}to{top:10px;color:", ";}}@keyframes arrow_blur{from{top:10px;color:", ";}to{top:-55px;color:", ";}}}"], _ui__WEBPACK_IMPORTED_MODULE_10__["P"], function (_ref2) {
...
//# sourceMappingURL=index.js.df2ef7f4d27f6544092a.hot-update.js.map