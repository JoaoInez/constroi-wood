...
})(["overflow:hidden;", "{text-shadow:none;animation-name:", ";animation-duration:0.2s;animation-fill-mode:both;&:hover{animation-name:hover;}@keyframes hover{from{transform:translateY(0);}to{transform:translateY(20px);}}@keyframes blur{from{transform:translateY(20px);}to{transform:translateY(0);}}}"], _ui__WEBPACK_IMPORTED_MODULE_10__["P"], function (_ref2) {
...
//# sourceMappingURL=index.js.13a348e64578690d753b.hot-update.js.map