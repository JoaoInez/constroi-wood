...
var Button = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].button.withConfig({
...
})(["font-size:", ";margin:", ";padding:", ";background-color:", ";color:", ";border:2px solid ", ";border-radius:3px;display:", " justify-content:", ";align-items:", " cursor:pointer;transition:all 0.15s ease-in-out;&:hover{color:", ";background-color:", ";box-shadow:", ";}"], function (_ref) {
  ...
  var _ref7$flex = _ref7.flex,
      flex = _ref7$flex === void 0 ? false : _ref7$flex;
  return flex ? "flex" : "initial";
}, function (_ref8) {
  var _ref8$justify = _ref8.justify,
      justify = _ref8$justify === void 0 ? "initial" : _ref8$justify;
  return justify;
}, function (_ref9) {
  var _ref9$align = _ref9.align,
      align = _ref9$align === void 0 ? "initial" : _ref9$align;
  return align;
}, function (_ref10) {
...
//# sourceMappingURL=index.js.e0eea53a61a9f94cde27.hot-update.js.map