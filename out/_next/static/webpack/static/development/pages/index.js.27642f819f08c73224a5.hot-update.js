...
})(["overflow:hidden;position:relative;", "{text-shadow:none;animation-name:", ";animation-duration:0.2s;animation-fill-mode:both;pointer-events:none;animation-delay:", ";&:hover{animation-name:hover;}@keyframes text_hover{from{transform:translateY(0);}to{transform:translateY(40px);}}@keyframes text_blur{from{transform:translateY(40px);}to{transform:translateY(0);}}}", "{position:absolute;height:40px;top:10px;transform:translateY(-50px);right:calc(50% - 10px);animation-name:", ";animation-duration:0.2s;animation-fill-mode:both;animation-delay:", ";@keyframes arrow_hover{from{transform:translateY(-50px);}to{transform:translateY(0);}}@keyframes arrow_blur{from{transform:translateY(0);}to{transform:translateY(-50px);}}}"], _ui__WEBPACK_IMPORTED_MODULE_10__["P"], function (_ref2) {
...
})(["overflow:hidden;position:relative;", "{animation-name:", ";animation-duration:0.2s;animation-fill-mode:both;pointer-events:none;animation-delay:", ";&:hover{animation-name:hover;}@keyframes text_hover{from{transform:translateX(0);}to{transform:translateX(-10px);color:", ";}}@keyframes text_blur{from{transform:translateX(-10px);color:", ";}to{transform:translateX(0);color:", ";}}}", "{position:absolute;width:40px;top:10px;right:calc(50% - 20px);animation-name:", ";animation-duration:0.2s;animation-fill-mode:both;animation-delay:", ";opacity:0;@keyframes arrow_hover{from{right:calc(50% - 20px);opacity:0;}to{right:10px;opacity:1;}}@keyframes arrow_blur{from{right:10px;opacity:1;}to{right:calc(50% - 20px);opacity:0;}}}"], _ui__WEBPACK_IMPORTED_MODULE_10__["P"], function (_ref6) {
...
//# sourceMappingURL=index.js.27642f819f08c73224a5.hot-update.js.map