...
})(["animation-name:blur;animation-duration:0.2s;animation-fill-mode:both;&:hover{animation-name:hover;}@keyframes hover{from{transform:translateY(0);}to{transform:translateY(70px);}}@keyframes blur{from{transform:translateY(70px);}to{transform:translateY(0);}}"]);
...
//# sourceMappingURL=index.js.17027671f2cceb8c79db.hot-update.js.map